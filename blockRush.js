...
const track1 = new createSound('audio\\track1.mp3', 0.1, true);
...
function startGame(){
    ...
    game = new createGame();
    //balls = [new createBall(canvasWidth / 2, canvasHeight / 2 + 10, 4, 6, 5), new createBall(canvasWidth / 2, canvasHeight / 2 + 10, 5, 6, 5), new createBall(canvasWidth / 2, canvasHeight / 2 + 10, 3, -6, 5)];
